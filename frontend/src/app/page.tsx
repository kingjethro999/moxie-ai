...
export default function MoxieLanding() {
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-zinc-400 selection:bg-white selection:text-black font-sans antialiased">
      
      {/* 1. MINIMAL NAV */}
      <nav className="fixed top-0 z-[100] w-full border-b border-zinc-800 bg-[#030303]/80 backdrop-blur-md">
      ...
      <section className="relative pt-40 pb-20 border-b border-zinc-900">
        ...
        {/* Subtle Brand Accent (Bottom Right) - Only gradient allowed */}
        <div className="absolute bottom-0 right-0 w-1/4 h-px bg-gradient-to-r from-transparent via-zinc-600 to-zinc-400 opacity-40" />
      </section>
      ...
      <section className="border-b border-zinc-800 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div>
              <div className="text-zinc-100 font-mono text-sm mb-2">01 // VISION</div>
            ...
            <div>
              <div className="text-zinc-100 font-mono text-sm mb-2">02 // PRIVACY</div>
            ...
            <div>
              <div className="text-zinc-100 font-mono text-sm mb-2">03 // COST</div>
            ...
            <div>
              <div className="text-zinc-100 font-mono text-sm mb-2">04 // STACK</div>
      ...
      <div className="py-16 bg-[#050505] border-b border-zinc-800">
      ...
      <section className="py-24 border-t border-zinc-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-zinc-950 border border-zinc-900 p-1 rounded-sm shadow-2xl">
            <div className="border border-zinc-800 bg-[#030303]">
              {/* Terminal Header */}
              ...
              <div className="p-8 grid md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  <div className="inline-flex px-2 py-0.5 rounded bg-zinc-800 text-zinc-300 text-[10px] font-bold uppercase tracking-wider">Multimodal</div>
                ...
                <div className="border-b border-zinc-800 bg-[#030303] p-6 rounded font-mono text-[11px] text-zinc-500">
                  <div className="mb-2 text-zinc-300 tracking-tighter uppercase font-bold text-[9px] border-b border-zinc-800 pb-2">Analysis Log</div>
                  ...
                  <div className="text-zinc-300 mt-4">MATCH FOUND: expo-router v3.5 conflict.</div>
                  <div className="mt-2 py-1 px-2 bg-zinc-800 text-zinc-300 border border-zinc-700 inline-block italic">
      ...
      {/* 6. SYSTEM FOOTER */}
      <footer className="py-12 border-t border-zinc-800 bg-[#030303]">
