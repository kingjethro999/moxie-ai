...
import { Terminal, Mail, Lock, Loader2, MessageSquare } from "lucide-react";
...
function LoginContent() {
  ...
  }, [user, loading, pendingMessage, redirectTo, router]);
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-zinc-500 text-sm">
              {pendingMessage ? "to continue your conversation" : "Access your Moxie workspace"}
            </p>
          </div>
          ...
          <p className="mt-6 text-center text-zinc-500 text-sm">
            ...
            <Link href={`/auth/signup${pendingMessage ? `?message=${encodeURIComponent(pendingMessage)}` : ""}`} className="text-white hover:underline">
              Create one
            </Link>
          </p>
        </div>
